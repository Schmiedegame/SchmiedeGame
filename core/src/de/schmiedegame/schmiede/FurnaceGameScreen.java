...
public class FurnaceGameScreen extends ScreenAdapter {
    ...
    public FurnaceGameScreen(Smithinggame game, MainGameScreen gameScreen) {
        ...
        initiate_FurnanceButton();
        initiate_PlayButton();
        initiate_LeaveButton();
        initiate_Instruction();
        initiate_Timer();
        initiate_Group();
    ...
    public void initiate_FurnanceButton() {
    ...
    public void initiate_PlayButton() {
    ...
    public void initiate_LeaveButton() {
    ...
    public void initiate_Instruction() {
