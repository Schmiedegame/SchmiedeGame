...
public class Player {
    ...
    private final int Y_BOUNDS_DOWN = 56;
    private final int Y_BOUNDS_UP = 442;
    private final int X_BOUNDS_LEFT = 122;
    private final int X_BOUNDS_RIGHT = 813;
    ...
    public void update(float delta) {
        ...
        if(position_vector.x + movement_vector.x < X_BOUNDS_RIGHT && position_vector.x + movement_vector.x > X_BOUNDS_LEFT) {
            position_vector.x += movement_vector.x;
        }
        if(position_vector.y + movement_vector.y < Y_BOUNDS_UP && position_vector.y + movement_vector.y > Y_BOUNDS_DOWN) {
