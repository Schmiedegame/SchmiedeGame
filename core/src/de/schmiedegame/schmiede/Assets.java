...
public class Assets {
    ...
    private static Array<Texture> casting_background_textures;
    ...
    private static Texture casting_background_finished_texture;
    public static TextureRegion casting_background_finished;

    private static Texture score_background_texture;
    ...
    private static void load_casting_background() {
        casting_background_textures = new Array<Texture>(5);
        for (int i = 1; i < 5+1; i++) {
        ...
        casting_background_finished_texture = new Texture("Casting_background_finished.png");
    ...
    private static void load_score_background() {
        score_background_texture = new Texture("score_background.png");
